...
public class Guitars implements Serializable {
    ...
    public Guitars(String guitarrID) {
        this.guitarrID = guitarrID;
    }

    public Guitars(String guitarrID, String name, int price, String description, boolean sold, String imagePath) {
        this.guitarrID = guitarrID;
        this.name = name;
        this.price = price;
    ...
    public String getGuitarrID() {
        return guitarrID;
    }

    public void setGuitarrID(String guitarrID) {
        this.guitarrID = guitarrID;
    }
    ...
    public String toString() {
        return "se.miun.test.model.Guitars[ guitarrID=" + guitarrID + " ]";
    }
