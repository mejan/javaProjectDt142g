...
/**
 * This class used as a GUI for the users to get
 * price and Vat from the database between two dates.
 * It's mainly a JPanel with 6 JLabels, 4 JTextFields
 * and 1 JButton.
 * @author Mikael Falck.
 */
public class VATCounterReader extends javax.swing.JPanel {
    ...
    /**
     * Constructor calls a new ContainerVATCouterReader,
     * calls the design view generated code and sets the
     * two lowest JTextFields become read only.
     */
    VATCounterReader() {
